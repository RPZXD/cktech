<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sidebar) {
      sidebar.classList.toggle('bg-gray-900', savedTheme === 'light-mode');
      sidebar.classList.toggle('bg-black', savedTheme === 'dark-mode');
    }
    ...
    if (themeToggle) {
      themeToggle.addEventListener('change', function() {
        ...
        if (sidebar) {
          ...
          sidebar.classList.toggle('bg-black', isDarkMode);
        }
