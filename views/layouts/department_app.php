...
/**
 * Department Layout
 * MVC Pattern - Main layout template for department pages
 */
...
<head>
    ...
    <title><?php echo $pageTitle ?? 'หัวหน้ากลุ่มสาระ'; ?> | <?php echo $global['nameschool']; ?></title>
...
<body class="font-mali bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 min-h-screen transition-colors duration-500">
    ...
    <div id="preloader" class="fixed inset-0 z-50 flex items-center justify-center bg-white dark:bg-slate-900 transition-opacity duration-500">
        <div class="text-center">
            ...
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-300 animate-pulse"><?php echo $config['global']['pageTitle'] ?? 'ระบบหัวหน้ากลุ่มสาระ'; ?></p>
        </div>
    </div>
    
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <?php include __DIR__ . '/../components/department_sidebar.php'; ?>
